...
1. **Writes the runtime** `.auto-embedded/`: workflow engine scripts, spec seeds, 24 tool scripts (`tools/`), the 80+ article knowledge base (`refs/`), 13 specialized workflows (`modes/`), and `workflow.md`
