...
>
> 关联：`modes/industrial-data-acquisition.md` 子系统 3、`refs/example-siemens-cimc-2025.md`
...
- **集成框架**：`modes/industrial-data-acquisition.md` 子系统 3
- **完整端到端示例**：`refs/example-siemens-cimc-2025.md`
- **letter-shell（更强大的现成库）**：`refs/embed-libs-index.md` §2.4
