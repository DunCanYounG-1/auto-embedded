...
2. refs/competition-task-router.md  — 第 0 步必读：MAIN + TAGS 路由
3. refs/competition-scoring-checklist-template.md  — 第 0 步必读：5 元组验收表
```
...
- 失败兜底分类（看 refs/failure-taxonomy.md）
