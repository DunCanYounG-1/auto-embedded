/** send/interrupt 的文本体解析：<text> 参数 / --text-file / --stdin（verbatim 自 Trellis）。 */
...
async function readChannelTextBody(opts: ChannelTextBodyOptions): Promise<string | undefined> {
